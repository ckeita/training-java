                    ...
                    <form data-toggle="validator" role="form" action="addcomputer" id="form_id" name="computerToAdd" method="POST">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="<spring:message code="name"/>" required>
                            </div>
                            <div class="form-group">
                                 <div class="input-append date" id="introduced_date">
                                 <label for="introduced"><spring:message code="introduced"/></label>
                                 	<input type="date" class="form-control" id="introduced" name="introduced" placeholder="<spring:message code="introduced"/>">
                                 </div>
                            </div>
                            <div class="form-group">
                                <div class="input-append date" id="discontinued_date">
                                	<label for="discontinued_date"><spring:message code="discontinued"/></label>
                                	<input type="date" class="form-control" id="discontinued" name="discontinued" placeholder="<spring:message code="discontinued"/>">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="actions pull-right">
                            <input type="submit" value="<spring:message code="addSubmit" />" class="btn btn-primary">
                            or
